...
import { V24_ITEMS } from "./expansionV24.js";
...
export const ITEMS = {
  ...
  iceguard_helm: {
    ...
    health: 14,
    sellValue: 82,
    dropSource: "Frostbound Vault elites",
    visualColor: 0x6f94a8,
    icon: "IG-H",
    description: "A ridged front-line helm from the Iceguard set."
  },
  iceguard_chestplate: {
    id: "iceguard_chestplate",
    name: "Iceguard Chestplate",
    type: "armor",
    slot: "chest",
    setId: "iceguard",
    rarity: RARITIES.RARE,
    ...
    speed: 0.97,
    sellValue: 110,
    dropSource: "Runebound Colossus",
    visualColor: 0x5d7f92,
    icon: "IG-C",
    description: "Heavy blue plate built for physical builds."
  },
  iceguard_gauntlets: {
    id: "iceguard_gauntlets",
    name: "Iceguard Gauntlets",
    type: "armor",
    slot: "hands",
    setId: "iceguard",
    rarity: RARITIES.RARE,
    ...
    attack: 4,
    sellValue: 78,
    dropSource: "Frozen Knight elites",
    visualColor: 0x7798ac,
    icon: "IG-G",
    description: "Thick gauntlets with sharpened knuckle plates."
  },
  iceguard_boots: {
    id: "iceguard_boots",
    name: "Iceguard Boots",
    ...
    speed: 1.03,
    sellValue: 74,
    dropSource: "Frostbound Vault chests",
    visualColor: 0x48677a,
    icon: "IG-B",
    description: "Steel-toed boots that hold steady on frozen stone."
  },
  zero_born_crown: {
    id: "zero_born_crown",
    name: "Zero-Born Crown",
    type: "armor",
    slot: "head",
    setId: "zero_born",
    rarity: RARITIES.RARE,
    ...
    magicPower: 8,
    sellValue: 88,
    dropSource: "Zero-Born vault casters",
    visualColor: 0xb7f2ff,
    icon: "ZB-C",
    description: "A narrow crown that focuses cold spellwork."
  },
  zero_born_robe: {
    id: "zero_born_robe",
    name: "Zero-Born Robe",
    ...
    sellValue: 112,
    dropSource: "Runebound Colossus",
    visualColor: 0x8fd8f1,
    icon: "ZB-R",
    description: "A bright layered robe laced with mana runes."
  },
  zero_born_gloves: {
    id: "zero_born_gloves",
    name: "Zero-Born Gloves",
    type: "armor",
    slot: "hands",
    setId: "zero_born",
    rarity: RARITIES.RARE,
    ...
    magicPower: 7,
    sellValue: 76,
    dropSource: "Frost Wisp elites",
    visualColor: 0xa8edff,
    icon: "ZB-G",
    description: "Spell gloves that leave a pale trail in the air."
  },
  zero_born_boots: {
    id: "zero_born_boots",
    name: "Zero-Born Boots",
    type: "armor",
    slot: "boots",
    setId: "zero_born",
    rarity: RARITIES.RARE,
    ...
    sellValue: 72,
    dropSource: "Frostbound Vault chests",
    visualColor: 0x73c7e3,
    icon: "ZB-B",
    description: "Light boots that hum with stored mana."
  },
  dawnmender_circlet: {
    id: "dawnmender_circlet",
    name: "Dawnmender Circlet",
    type: "armor",
    slot: "head",
    setId: "dawnmender",
    rarity: RARITIES.RARE,
    ...
    magicPower: 4,
    sellValue: 82,
    dropSource: "Vault healing caches",
    visualColor: 0xf4d586,
    icon: "DM-C",
    description: "A warm circlet worn by battlefield healers."
  },
  dawnmender_vestments: {
    id: "dawnmender_vestments",
    name: "Dawnmender Vestments",
    type: "armor",
    slot: "chest",
    setId: "dawnmender",
    rarity: RARITIES.RARE,
    ...
    sellValue: 108,
    dropSource: "Runebound Colossus",
    visualColor: 0xe9c768,
    icon: "DM-V",
    description: "Golden-trimmed vestments for sturdy support builds."
  },
  dawnmender_wraps: {
    id: "dawnmender_wraps",
    name: "Dawnmender Wraps",
    type: "armor",
    slot: "hands",
    setId: "dawnmender",
    rarity: RARITIES.RARE,
    ...
    magicPower: 4,
    sellValue: 74,
    dropSource: "Frostbound support objectives",
    visualColor: 0xf6dd9b,
    icon: "DM-W",
    description: "Soft wraps that brighten around wounded allies."
  },
  dawnmender_sandals: {
    id: "dawnmender_sandals",
    name: "Dawnmender Sandals",
    type: "armor",
    slot: "boots",
    setId: "dawnmender",
    rarity: RARITIES.RARE,
    ...
    sellValue: 70,
    dropSource: "Frostbound Vault chests",
    visualColor: 0xdab84e,
    icon: "DM-S",
    description: "Light healer sandals that keep pace with a party."
  },
  small_health_potion: {
