...
export const TRAINERS = {
  mage: {
    ...
    name: "Arcanist Mira",
    label: "Mage Trainer",
    abilityIds: ["hero_pulse", "ground_pound", "fireball", "dark_punch", "water_blast", "magma_breaker", "flame_wave", "thunder_leap", "storm_bolt"]
  },
  healer: {
    id: "healer",
    name: "Sister Elara",
    label: "Healer",
    abilityIds: ["healing_orb", "mend_ally", "hearth_ward", "static_renewal"]
  }
};
