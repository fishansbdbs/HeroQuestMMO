...
export class EnemySystem {
  ...
  spawnWorld() {
    ...
    this.spawnConfigured(STORMREACH_ISLES_SPAWNS, ZONES.STORMREACH_ISLES);
    this.spawnConfigured(SKYBREAKER_RUINS_SPAWNS, ZONES.SKYBREAKER_RUINS);
    this.spawnConfigured(TEMPEST_GATE_SPAWNS, ZONES.TEMPEST_GATE);
  }
